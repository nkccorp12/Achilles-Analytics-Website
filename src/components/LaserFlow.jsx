...
export default function LaserFlow({
  ...
  useEffect(() => {
    ...
    const onMove = ev => {
      ...
      mouseTarget.set((ev.clientX - rect.left) * ratio, rect.height * ratio - (ev.clientY - rect.top) * ratio);
    };
  ...
  useEffect(() => {
    ...
    u.uFogScale.value = fogScale; u.uWSpeed.value = wispSpeed;
    u.uWIntensity.value = wispIntensity; u.uFlowStrength.value = flowStrength;
    u.uDecay.value = decay; u.uFalloffStart.value = falloffStart;
