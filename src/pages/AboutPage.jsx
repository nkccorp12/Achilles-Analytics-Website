...
export default function AboutPage() {
  ...
  useEffect(() => {
    if (!notifOpen) return;
    const handler = (e) => {
      const dot = document.querySelector('.np-notif-dot');
      const stack = document.querySelector('.np-pill-stack');
        ...
        <div className="ab-section__inner">
          ...
          <ol className="ab-thesis">
            ...
            <li className="ab-thesis__item" data-reveal>
              ...
              <div className="ab-thesis__body">
                <h3 className="ab-thesis__title">The team is the <em>domain brain.</em> Agentic Coding is the print.</h3>
                <p>
